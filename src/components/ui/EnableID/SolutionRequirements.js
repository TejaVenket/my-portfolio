...
export default function SolutionRequirements({accent, accentBorder, accentMuted,client = "Tony Tan", org = "Gebirah",phase = "Phase 1 · Problem Scoping"}) {
  return (
    <div style={{ gridColumn: "1 / -1", marginTop: "1rem" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "2rem" }}>
        ...
        <p style={{
          ...
          Phase 2 · Solution Requirements and Market Research
        </p>
        <div style={{ flex: 1, height: "0.5px", background: "rgba(255,255,255,0.07)" }} />
      </div>
