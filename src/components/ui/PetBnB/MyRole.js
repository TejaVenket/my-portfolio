      ...
      <div style={{ gridColumn: "1 / -1", marginTop: "3rem" }}>
        ...
        <div className="flex items-center" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "3rem", alignItems: "center" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
            {[
              { area: "User Research", detail: "Conducting Surveys and understanding user demographics" },
              { area: "Frontend Development", detail: "Implemented responsive UI components and interactive features" },
              { area: "Figma and Paper Prototyping", detail: "Created paper and figma Prototypes" },
              { area: "User Testing", detail: "One on One testing sessions with users at each iteration" },
            ].map((item) => (
              <div
                key={item.area}
                style={{
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1.1rem" }}>
            <p style={{ fontSize: "14px", color: "rgba(255,255,255,0.55)", lineHeight: 1.85 }}>
              I played a key role in shaping both the UI/UX design, frontend development and user research of 
              PetBnB. Throughout the project, I led much of the UI/UX design process—from 
